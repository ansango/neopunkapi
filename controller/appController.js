  ...
  try {
    responses.success(res, {
      ...
      endPoints: {
        index: "/",
        getAllBeers: "/beers",
        getBeerByID: "/beers/id/:id",
        getBeerByName: "/beers/:name",
        getBeersBySection: "/beers/section/:section",
        getBeersByStyle: "/beers/style/:style",
        sortByLowABV: "/beers/sort/low-abv",
        sortByHighABV: "/beers/sort/high-abv",
      },
    });
  } catch (error) {
    responses.error(res);
